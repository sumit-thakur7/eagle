        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="mt-4 text-sm text-gray-700">
              Experience the freedom of flight with India's premier paragliding destination.
          ...
          <div>
            ...
            <div className="mt-6 space-y-3 text-sm text-gray-700">
              ...
              <div className="flex items-center gap-2">
                <FaEnvelope className="text-yellow-500" /> info@geparagliding.org
              </div>
              <div className="flex items-center gap-2">
                <FaMapMarkerAlt className="text-yellow-500" /> Bir Billing, Himachal Pradesh, India
              </div>
            </div>
          </div>
        </div>
