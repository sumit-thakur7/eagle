...
export default function TestimonialsBanner() {
  return (
    <div className="relative bg-gradient-to-r from-gray-500 to-gray-300 py-24 text-center">
      <h1 className="text-white text-4xl font-extrabold mb-4"> Testimonials</h1>
      <p className="text-white max-w-3xl mx-auto text-lg px-4">
      Don't just take our word for it. Hear from the adventurers who have experienced the thrill of paragliding with us.
      </p>
